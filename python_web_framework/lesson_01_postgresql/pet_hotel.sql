...
ALTER TABLE public.cat_room_cat_room_id_seq OWNER TO postgres;

--
-- Name: cat_room_cat_room_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.cat_room_cat_room_id_seq OWNED BY public.cat_room.cat_room_id;
...
CREATE TABLE public.dog (
    ...
    dog_name character varying(15) NOT NULL,
...
--
-- Name: cat_room cat_room_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.cat_room ALTER COLUMN cat_room_id SET DEFAULT nextval('public.cat_room_cat_room_id_seq'::regclass);
...
--
-- Name: cat_room cat_room_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.cat_room
    ADD CONSTRAINT cat_room_pk PRIMARY KEY (cat_room_id);
...
--
-- Name: cat_room cat_room_cat__fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: dog dog_owner__fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.dog
    ADD CONSTRAINT dog_owner__fk FOREIGN KEY (owner_id) REFERENCES public.owner(owner_id) ON UPDATE CASCADE ON DELETE CASCADE;
